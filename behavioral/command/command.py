...
class Light:
    ...
    def change_color(self, color: str) -> None:
        self.color = color
        print(f'{self.name} in {self.room} is set to {self.color}')
...
class LightOnOffCommand(ICommand):
    """ Comando concreto """
...
if __name__ == '__main__':
    ...
    bedroom_light_on = LightOnOffCommand(bedroom_light)
    bathroom_light_on = LightOnOffCommand(bathroom_light)
